...
//!
//! This code was generated by `zbus-xmlgen` `3.1.0` from DBus introspection
//! data. Source: `Interface '/org/freedesktop/login1' from service
//! 'org.freedesktop.login1' on system bus`.
//!
